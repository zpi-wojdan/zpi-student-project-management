...
VALUES
    ...
    ('Program do analizy efektywności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis11', 'Description11', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'john.doe@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2021/22-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ...
    ('System do symulacji ruchu drogowego', 'Road traffic simulation system', 'Opis13', 'Description13', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.taylor@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Symulator pracy robota sprzątającego w środowisku wirtualnym', 'Robot vaccum operation simulator in virtual environment', 'Opis14', 'Description14', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'john.doe@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Rozproszony serwer rozpoznawania mowy z udostępnianiem zasobów obliczeniowych na komputerach użytkowników', 'Distributed speech recognition server using local users computational resources', 'Opis15', 'Description15', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.taylor@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Program do analizy efektywności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis16', 'Description16', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'john.doe@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ...
    ('System zarządzania relacjami studentów z pracownikami uczelni', 'Student relation management', 'Opis20', 'Description20', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.young@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2021/22-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('SRM: System zarządzania relacjami z naukowcami', 'SRM: Scientists Relationship Management System', 'Opis21', 'Description21', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.young@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2021/22-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('System wspomagający planowanie wspólnych dojazdów z wykorzystaniem technologii Blockchain', 'A system to support the planning of carpooling using Blockchain technology', 'Opis22', 'Description22', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.cooper@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2021/22-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ...
    ('System wspomagający tworzenie i przeprowadzenie kampanii fundrisingowej dla podmiotów NGO.', 'A system to support the creation and execution of a fundrising campaign for NGO entities', 'Opis24', 'Description24', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.bryant@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2020/21-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ...
    ('Program do analizy efektywności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis28', 'Description28', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.cooper@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Program do analizy wydajności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis29', 'Description29', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'michael.evans@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ...
    ('Aplikacja do ewidencji świadczonych usług oraz pracy', 'Application for accounting provided services and work', 'Opis33', 'Description33', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.king@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ...
    ('System wspomagający rozpoznawania obrazów', 'Image recognition support system', 'Opis36', 'Description36', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2020/21-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ...
    ('System wspierający organizację konkursu Polish Project Excellence Award', 'System for Polish Project Excellence Award', 'Opis40', 'Description40', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.wells@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),

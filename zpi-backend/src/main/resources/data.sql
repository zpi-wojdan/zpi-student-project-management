...
VALUES
    ...
    ('System wspomagający rodzica w organizacji aktywnego spędzania czasu z dzieckiem', 'System to assist the parent in organizing active time with the child', 'Opis5', 'Description5', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.lewis@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Draft'), NOW()),
    ('System wspomagający tworzenie i przeprowadzenie kampanii fundrisingowej dla podmiotów NGO.', 'A system to support the creation and execution of a fundrising campaign for NGO entities', 'Opis6', 'Description6', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'david.brown@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Draft'), NOW()),
    ('System wspomagający planowanie wspólnych dojazdów z wykorzystaniem technologii Blockchain', 'A system to support the planning of carpooling using Blockchain technology', 'Opis7', 'Description7', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.lewis@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Draft'), NOW()),
    ('Rytmiczna gra komputerowa wykorzystująca "walking piano" w rzeczywistości rozszerzonej', 'Rhythm video game using walking piano in augmented reality', 'Opis8', 'Description8', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'michael.johnson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Draft'), NOW()),
    ('Aplikacja rzeczywistości rozszerzonej wspomagająca grę na instrumencie muzycznym', 'Augmented Reality application that supports playing musical instrument', 'Opis9', 'Description9', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.lewis@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Draft'), NOW()),
    ('System wspierający dobór recenzentów artykułów', 'System supporting articles reviewers selection', 'Opis10', 'Description10', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.baker@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Draft'), NOW()),
    ('Program do analizy efektywności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis11', 'Description11', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'john.doe@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('System rozpoznawania mowy do współpracy z dowolnym programem w systemie Windows', 'Speech recognition system colaborating with any Windows GUI program', 'Opis12', 'Description12', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.baker@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('System do symulacji ruchu drogowego', 'Road traffic simulation system', 'Opis13', 'Description13', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.taylor@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Symulator pracy robota sprzątającego w środowisku wirtualnym', 'Robot vaccum operation simulator in virtual environment', 'Opis14', 'Description14', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'john.doe@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Rozproszony serwer rozpoznawania mowy z udostępnianiem zasobów obliczeniowych na komputerach użytkowników', 'Distributed speech recognition server using local users computational resources', 'Opis15', 'Description15', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.taylor@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Program do analizy efektywności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis16', 'Description16', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'john.doe@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Aplikacja do zarządzania wydatkami grupowymi i osobistymi', 'Application to manage group and personal expenses', 'Opis17', 'Description17', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.green@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Aplikacja webowa wspomagająca przeprowadzanie sesji gry RPG "Mafia" z możliwością gry zdalnej', 'Web application supporting conducting of RPG game "Mafia" session, with option to play remotely', 'Opis18', 'Description18', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.green@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('Komunikator internetowy z możliwością udostępniania położenia', 'Internet communicator with location sharing function', 'Opis19', 'Description19', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.green@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ('System zarządzania relacjami studentów z pracownikami uczelni', 'Student relation management', 'Opis20', 'Description20', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.young@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('SRM: System zarządzania relacjami z naukowcami', 'SRM: Scientists Relationship Management System', 'Opis21', 'Description21', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.young@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('System wspomagający planowanie wspólnych dojazdów z wykorzystaniem technologii Blockchain', 'A system to support the planning of carpooling using Blockchain technology', 'Opis22', 'Description22', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.cooper@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('System wspomagający rodzica w organizacji aktywnego spędzania czasu z dzieckiem', 'System to assist the parent in organizing active time with the child', 'Opis23', 'Description23', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.khan@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('System wspomagający tworzenie i przeprowadzenie kampanii fundrisingowej dla podmiotów NGO.', 'A system to support the creation and execution of a fundrising campaign for NGO entities', 'Opis24', 'Description24', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.bryant@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Rejected'), NOW()),
    ('System wspomagający integrację oraz komunikację webowych i mobilnych aplikacji IoT', 'System for communication and integration of IoT applications with mobile and web services', 'Opis25', 'Description25', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.bryant@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Symulator pracy robota sprzątającego w środowisku wirtualnym', 'Robot vaccum operation simulator in virtual environment', 'Opis26', 'Description26', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.cooper@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Rozproszony serwer rozpoznawania mowy z udostępnianiem zasobów obliczeniowych na komputerach użytkowników', 'Distributed speech recognition server using local users computational resources', 'Opis27', 'Description27', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.bryant@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Program do analizy efektywności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis28', 'Description28', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.cooper@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Program do analizy wydajności instalacji fotowoltaicznej', 'A program for photovoltaic system efficiency analysis', 'Opis29', 'Description29', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'michael.evans@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('System rozpoznawania mowy do współpracy z dowolnym programem w systemie Windows', 'Speech recognition system colaborating with any Windows GUI program', 'Opis30', 'Description30', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.khan@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('System do symulacji ruchu drogowego', 'Road traffic simulation system', 'Opis31', 'Description31', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'michael.evans@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('System do zarządzania i monitorowania upraw hydroponicznych', 'System for managing and monitoring hydroponic crops', 'Opis32', 'Description32', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Aplikacja do ewidencji świadczonych usług oraz pracy', 'Application for accounting provided services and work', 'Opis33', 'Description33', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.king@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Zaprojektowanie i zaimplementowanie systemu do automatyzacji zarządzania wynajmem nieruchomości', 'Design and implementation of an automated management system for property rental', 'Opis34', 'Description34', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.khan@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('Narzędzie do anotacji ontologicznej zdjęć dwuwymiarowych', 'A tool for 2D image ontological annotation.', 'Opis35', 'Description35', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.king@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('System wspomagający rozpoznawania obrazów', 'Image recognition support system', 'Opis36', 'Description36', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Approved'), NOW()),
    ('System obsługi rodzinnych ogrodów działkowych', 'System of service for family allotment gardens', 'Opis37', 'Description37', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.nelson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2020/21-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Narzędzie do anotacji ontologicznej zdjęć dwuwymiarowych', 'A tool for 2D image ontological annotation.', 'Opis38', 'Description38', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.nelson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2020/21-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System wspierający organizację grupowych aktywności sportowych', 'System supporting the organization of group sports activities', 'Opis39', 'Description39', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.bryant@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2021/22-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System wspierający organizację konkursu Polish Project Excellence Award', 'System for Polish Project Excellence Award', 'Opis40', 'Description40', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.wells@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2021/22-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Komunikator internetowy z możliwością udostępniania położenia', 'Internet communicator with location sharing function', 'Opis41', 'Description41', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.wells@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System obsługi stołówek szkolnych', 'School canteen management system', 'Opis42', 'Description42', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.nelson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Aplikacja do zarządzania wydatkami grupowymi i osobistymi', 'Application to manage group and personal expenses', 'Opis43', 'Description43', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2022/23-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW());
...
VALUES
    ...
    ((SELECT id FROM student WHERE mail = '543210@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '432109@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '321098@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '210987@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '109876@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '987601@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '876502@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '765403@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '654304@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '543205@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '432106@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '321007@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '210908@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ...
    ((SELECT id FROM student WHERE mail = '988710@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '877611@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),
    ((SELECT id FROM student WHERE mail = '766512@student.pwr.edu.pl'), (SELECT id FROM program WHERE name = 'W04-ISTP-000P-OSIW7'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z')),

...
VALUES
    ...
    ('System do symulacji ruchu drogowego', 'Road traffic simulation system', 'Opis13', 'Description13', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.taylor@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Pending approval'), NOW()),
    ...
    ('System rozpoznawania mowy do współpracy z dowolnym programem w systemie Windows', 'Speech recognition system colaborating with any Windows GUI program', 'Opis30', 'Description30', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.khan@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Assigned'), NOW()),
    ('System do symulacji ruchu drogowego', 'Road traffic simulation system', 'Opis31', 'Description31', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'michael.evans@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Assigned'), NOW()),
    ('System do zarządzania i monitorowania upraw hydroponicznych', 'System for managing and monitoring hydroponic crops', 'Opis32', 'Description32', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Assigned'), NOW()),
    ('Aplikacja do ewidencji świadczonych usług oraz pracy', 'Application for accounting provided services and work', 'Opis33', 'Description33', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.king@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Assigned'), NOW()),
    ('Zaprojektowanie i zaimplementowanie systemu do automatyzacji zarządzania wynajmem nieruchomości', 'Design and implementation of an automated management system for property rental', 'Opis34', 'Description34', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'william.khan@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Assigned'), NOW()),
    ('Narzędzie do anotacji ontologicznej zdjęć dwuwymiarowych', 'A tool for 2D image ontological annotation.', 'Opis35', 'Description35', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.king@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System wspomagający rozpoznawania obrazów', 'Image recognition support system', 'Opis36', 'Description36', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System obsługi rodzinnych ogrodów działkowych', 'System of service for family allotment gardens', 'Opis37', 'Description37', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.nelson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Narzędzie do anotacji ontologicznej zdjęć dwuwymiarowych', 'A tool for 2D image ontological annotation.', 'Opis38', 'Description38', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.nelson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System wspierający organizację grupowych aktywności sportowych', 'System supporting the organization of group sports activities', 'Opis39', 'Description39', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'ava.bryant@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System wspierający organizację konkursu Polish Project Excellence Award', 'System for Polish Project Excellence Award', 'Opis40', 'Description40', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.wells@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Komunikator internetowy z możliwością udostępniania położenia', 'Internet communicator with location sharing function', 'Opis41', 'Description41', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'sophia.wells@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('System obsługi stołówek szkolnych', 'School canteen management system', 'Opis42', 'Description42', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'daniel.nelson@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW()),
    ('Aplikacja do zarządzania wydatkami grupowymi i osobistymi', 'Application to manage group and personal expenses', 'Opis43', 'Description43', 5, (SELECT e.id FROM Employee e WHERE e.mail = 'olivia.fisher@pwr.edu.pl'), (SELECT id FROM study_cycle WHERE name = '2023/24-Z'), (SELECT id FROM status WHERE name = 'Closed'), NOW());

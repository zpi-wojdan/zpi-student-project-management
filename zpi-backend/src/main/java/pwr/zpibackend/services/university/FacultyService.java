...
public class FacultyService {
    ...
    public Faculty saveFaculty(FacultyDTO faculty) throws AlreadyExistsException{
    ...
    public Faculty deleteFaculty(Long id) throws NotFoundException {
    ...
    public Faculty updateFaculty(Long id, FacultyDTO faculty) throws NotFoundException {
